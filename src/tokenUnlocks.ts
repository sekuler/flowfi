...
export const TOKEN_UNLOCKS: TokenUnlockInfo[] = [
  ...
  },
  {
    ...
    unlockStatus: {
      type: "no_fixed_schedule",
      note: "More precise breakdown (Aug 2026): ~293,710 ETHFI/day in small daily/linear Core Contributors releases, PLUS a separate larger periodic event of ~9.69M ETHFI (~0.97% of supply) roughly monthly (e.g. Aug 18, Sep 18, Oct 18, 2026). Two distinct mechanisms — don't conflate them into one daily average.",
    },
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-09-01",
      amount: "275,015,625 ENA (Insiders/Investors/Community/Foundation)",
      percentOfCirculating: "1.83% of total supply, ~2.9% of market cap",
    },
    source: "https://defillama.com/protocol/unlocks/ethena — confirmed via Tokenomics.com cross-check (2026-08-15): resolves earlier source disagreement, this is the current-confirmed next event. Monthly recurring pattern continues after this date.",
    recordedAt: "2026-08-11",
  },
  {
  ...
  },
  {
    ...
    name: "XRP",
    symbol: "XRP",
    circulatingSupply: "62.5B XRP",
    maxSupply: "100B XRP",
    allocationBreakdown: { "Circulating": "62.5%", "Escrow": "37.5%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional vesting unlock. Ripple releases XRP from escrow on its own monthly schedule — this is a separate mechanism from a project vesting calendar and should be tracked independently." },
    source: "CoinMarketCap / Ripple escrow (via user-provided research file, 2026-08-15)",
  ...
  },
  {
    ...
    name: "Cosmos",
    symbol: "ATOM",
    circulatingSupply: "521.8M ATOM",
    maxSupply: "Unlimited",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional unlock — ATOM supply changes via network inflation/issuance, not project vesting." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "avantis",
    name: "Avantis",
    symbol: "AVNT",
    circulatingSupply: "333.25M AVNT",
    maxSupply: "1B AVNT",
    allocationBreakdown: { "Circulating": "33.3%", "Locked/Vesting": "66.7%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Vesting continues, but a complete verified 24-month amount-by-amount schedule was not available in accessible free sources as of Aug 2026 — don't invent a schedule." },
    source: "CoinMarketCap / Tokenomics tracker (via user-provided research file, 2026-08-15). CoinGecko ID not individually re-verified this session.",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "FTX Token",
    symbol: "FTT",
    circulatingSupply: "68.9M FTT",
    maxSupply: "352.2M FTT",
    allocationBreakdown: { "Circulating": "~19.6%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No standard project unlock schedule — subject to FTX's bankruptcy/liquidation process, not a normal vesting calendar." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "PancakeSwap",
    symbol: "CAKE",
    circulatingSupply: "322M CAKE",
    maxSupply: "400M CAKE (soft target)",
    allocationBreakdown: { "Circulating": "~80.5%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional cliff — ongoing emissions/burn model, already tracked in FlowFi's existing PancakeSwap entry." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15) — cross-check only, see existing 'pancakeswap' entry for full detail",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "1inch",
    name: "1inch",
    symbol: "1INCH",
    circulatingSupply: "1.41B 1INCH",
    maxSupply: "1.5B 1INCH",
    allocationBreakdown: { "Circulating": "~94%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No major future cliff identified — mostly circulating already." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Raydium",
    symbol: "RAY",
    circulatingSupply: "269.3M RAY",
    maxSupply: "555M RAY",
    allocationBreakdown: { "Circulating": "~48.5%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No major cliff identified — emissions/vesting mechanics rather than a clear future event; cross-check only, see existing 'raydium' entry for full detail." },
    source: "CoinMarketCap / DeFiLlama (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "near",
    name: "NEAR Protocol",
    symbol: "NEAR",
    circulatingSupply: "1.3B NEAR",
    maxSupply: "Unlimited",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional unlock — network issuance; historical vesting largely completed." },
    source: "CoinMarketCap / DeFiLlama (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Injective",
    symbol: "INJ",
    circulatingSupply: "100M INJ",
    maxSupply: "100M INJ",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No major scheduled unlock identified — network emissions/supply mechanics." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "ORDI",
    symbol: "ORDI",
    circulatingSupply: "21M ORDI",
    maxSupply: "21M ORDI",
    allocationBreakdown: { "Circulating": "100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Fully circulating, no unlock schedule." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Compound",
    symbol: "COMP",
    circulatingSupply: "10M COMP",
    maxSupply: "10M COMP",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Effectively fully circulating, no major vesting unlock identified." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Decentraland",
    symbol: "MANA",
    circulatingSupply: "1.99B MANA",
    maxSupply: "2.19B MANA",
    allocationBreakdown: { "Circulating": "~90.7%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional future vesting event identified. Supply can change through protocol mechanics." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Manta Network",
    symbol: "MANTA",
    circulatingSupply: "477.54M MANTA",
    maxSupply: "1B MANTA",
    allocationBreakdown: { "Circulating": "~47.8%" },
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-17",
      amount: "14,028,297 MANTA",
      percentOfCirculating: "1.4% of supply, ~2.1% of market cap",
    },
    source: "Tokenomics.com / CoinMarketCap (via user-provided research file, 2026-08-15). Monthly schedule continues, 42 events remain through Jan 2030.",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Bittensor",
    symbol: "TAO",
    circulatingSupply: "11.2M TAO",
    maxSupply: "21M TAO",
    allocationBreakdown: { "Circulating": "~53%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional unlock — mining emissions toward the 21M cap, similar to Bitcoin." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    symbol: "FET",
    circulatingSupply: "2.24B FET",
    maxSupply: "2.719B FET",
    allocationBreakdown: { "Circulating": "~82.4%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No major future vesting cliff identified — supply changed through the ASI (Fetch.ai + SingularityNET + Ocean/Cudos) migration, not a simple vesting calendar." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Orca",
    symbol: "ORCA",
    circulatingSupply: "60.8M ORCA",
    maxSupply: "75M ORCA",
    allocationBreakdown: { "Circulating": "~81.1%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No major future cliff identified — historical vesting/emissions." },
    source: "CoinMarketCap / DeFiLlama (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Pyth Network",
    symbol: "PYTH",
    circulatingSupply: "7.87498B PYTH",
    maxSupply: "10B PYTH",
    allocationBreakdown: { "Circulating": "~78.7%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Tokenomics.com marks all scheduled vesting complete as of May 20, 2026. The remaining ~2.125B unlocked-but-not-circulating is NOT a future vesting unlock." },
    source: "Tokenomics.com (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "somnia",
    name: "Somnia",
    symbol: "SOMI",
    circulatingSupply: "243M SOMI",
    maxSupply: "1B SOMI",
    allocationBreakdown: { "Circulating": "~24.3%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Vesting continues; a complete verified 24-month amount list was not available in accessible free sources as of Aug 2026." },
    source: "CoinMarketCap / Tokenomics tracker (via user-provided research file, 2026-08-15). CoinGecko ID not individually re-verified this session.",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Polkadot",
    symbol: "DOT",
    circulatingSupply: "1.69B DOT",
    maxSupply: "Unlimited",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional unlock — ongoing issuance/inflation." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "succinct",
    name: "Succinct",
    symbol: "PROVE",
    circulatingSupply: "195M PROVE",
    maxSupply: "1B PROVE",
    allocationBreakdown: { "Circulating": "19.5%" },
    unlockStatus: {
      type: "scheduled",
      date: "2027-02-05",
      amount: "269,000,000 PROVE",
      percentOfCirculating: "26.90% of total supply",
    },
    source: "Tokenomics.com (via user-provided research file, 2026-08-15). Further events: Aug 5 2027 (21.2%), Feb 5 2028 (17.5%), Aug 5 2028 (14.9%). CoinGecko ID not individually re-verified this session.",
    recordedAt: "2026-08-15",
  },
  {
    coingeckoId: "enso",
    name: "Enso",
    symbol: "ENSO",
    circulatingSupply: "20.6M ENSO",
    maxSupply: "100M ENSO",
    allocationBreakdown: { "Circulating": "~20.6%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Monthly/vesting schedule exists; exact full 24-month event amounts were not available in accessible free sources as of Aug 2026." },
    source: "CoinMarketCap / Tokenomics tracker (via user-provided research file, 2026-08-15). CoinGecko ID not individually re-verified this session.",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Cyber",
    symbol: "CYBER",
    circulatingSupply: "72M CYBER",
    maxSupply: "100M CYBER",
    allocationBreakdown: { "Circulating": "~72%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Unlocks continue; exact full 24-month amount list not available in accessible free sources as of Aug 2026." },
    source: "CoinMarketCap / DeFiLlama (via user-provided research file, 2026-08-15). CoinGecko ID not individually re-verified this session.",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Optimism",
    symbol: "OP",
    circulatingSupply: "2.28647B OP",
    maxSupply: "4.294967296B OP",
    allocationBreakdown: { "Circulating": "53.2%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Tokenomics.com: final scheduled vesting event was Jun 28, 2026; no further events remain in that calendar. Remaining supply may still be locked but isn't assigned a future date." },
    source: "Tokenomics.com / CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    maxSupply: "10B ARB",
    allocationBreakdown: { "Circulating": "66.1%" },
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-23",
      amount: "139,152,778 ARB",
      percentOfCirculating: "1.39% of supply, ~2.0% of market cap",
    },
    source: "Tokenomics.com (via user-provided research file, 2026-08-15). Monthly cadence confirmed through Mar 2027 (final scheduled period). Note: other trackers show a different Aug 16 grouping (~92.65M) due to different event definitions — Tokenomics.com's definition used here.",
    recordedAt: "2026-08-15",
  },
  {
  ...
  },
  {
    ...
    name: "dogwifhat",
    symbol: "WIF",
    circulatingSupply: "998.8M WIF",
    maxSupply: "998.8M WIF",
    allocationBreakdown: { "Circulating": "~100%" },
    unlockStatus: { type: "no_fixed_schedule", note: "Fully circulating, no unlock schedule." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
  {
    ...
    name: "Render",
    symbol: "RENDER",
    circulatingSupply: "519M RENDER",
    maxSupply: "644M RENDER",
    allocationBreakdown: { "Circulating": "~80.5%" },
    unlockStatus: { type: "no_fixed_schedule", note: "No conventional vesting unlock — burn/mint emission mechanics rather than standard vesting." },
    source: "CoinMarketCap (via user-provided research file, 2026-08-15)",
    recordedAt: "2026-08-15",
  },
];
