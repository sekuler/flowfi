...
export const TOKEN_UNLOCKS: TokenUnlockInfo[] = [
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-12",
      amount: "~11.31M APT (~$6.62M total across Core Contributors, Community, Investors, Foundation)",
      percentOfCirculating: "1.34% of float",
    },
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-31",
      amount: "2.07M SUI (~$1.42M, Mysten Labs Treasury)",
      percentOfCirculating: "0.051% of float",
    },
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-29",
      amount: "20.83M MEGA (~$715,070.83, Fluffle Round)",
      percentOfCirculating: "1.84% of float",
    },
    source: "https://defillama.com/unlocks/megaeth-bridge",
    recordedAt: "2026-08-11",
  },
  {
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2027-01-17",
      amount: "~1.7101B ONDO (~$570.66M total: Ecosystem Growth 792.05M, Protocol Development 660M, Private Sales 258.05M)",
      percentOfCirculating: "35.12% of float",
    },
    source: "https://defillama.com/protocol/unlocks/ondo-finance",
    recordedAt: "2026-08-11",
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-31",
      amount: "36.82M EIGEN (~$6.39M total: Investors 19.75M, Early Contributors 17.07M)",
      percentOfCirculating: "4.97% of float",
    },
    source: "https://defillama.com/protocol/unlocks/eigencloud",
    recordedAt: "2026-08-11",
  },
  {
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-09-02",
      amount: "40.63M ENA (~$3.57M, Foundation)",
      percentOfCirculating: "0.27% of total supply",
    },
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-11-20",
      amount: "1M MORPHO (~$1.97M, Market Makers)",
      percentOfCirculating: "0.15% of float",
    },
    source: "https://defillama.com/protocol/unlocks/morpho",
    recordedAt: "2026-08-11",
  },
  {
    coingeckoId: "uniswap",
  ...
  },
  {
    ...
    unlockStatus: {
      type: "scheduled",
      date: "2026-08-31",
      amount: "3.13M ACX (~$125,598.97, Risk Labs Team)",
      percentOfCirculating: "0.44% of float",
    },
    source: "https://defillama.com/protocol/unlocks/across",
    recordedAt: "2026-08-11",
  },
  {
    coingeckoId: "jupiter",
